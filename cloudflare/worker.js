  ...
  <head>
    ...
    <style>
      *{box-sizing:border-box}
      ...
      .print-btn{display:inline-flex;align-items:center;justify-content:center;height:46px;padding:0 20px;border:0;border-radius:999px;background:#000;color:#fff;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:15px;font-weight:500;letter-spacing:-.02em;text-transform:none;text-decoration:none;cursor:pointer;transition:.25s}
      .print-btn:hover{background:#000;transform:translateY(-2px)}
